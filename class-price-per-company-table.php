 ...
 * summary
 */
class Price_per_company_table extends WP_List_Table
{
    /**
     * summary
     */
    ...
    {
        parent::__construct( [
			'singular' => __( 'Price_per_company', 'e-boutique' ), //singular name of the listed records
			'plural'   => __( 'Price_per_company', 'e-boutique' ), //plural name of the listed records
	...
	public function get_price_list(){
		...
		if (isset($_GET['ci'])) {
			$item_id = $_GET['ci'];
			$results = $wpdb->get_results("SELECT * FROM $table_delivery_cities, $table_delivery_pricing, $table_delivery_delay  WHERE $table_delivery_cities.id = $table_delivery_pricing.delivery_cities_id and $table_delivery_pricing.id= $table_delivery_delay.pricing_id and $table_delivery_pricing.delivery_companies_id='$item_id';", ARRAY_A);
		}else{
			$results= array();
		}
