 ...
 * summary
 */
class Cities_districts_table extends WP_List_Table
{
    /**
     * summary
     */
    ...
    {
        parent::__construct( [
			'singular' => __( 'Cities_districts', 'e-boutique' ), //singular name of the listed records
			'plural'   => __( 'Cities_districts', 'e-boutique' ), //plural name of the listed records
	...
	public function column_label($item) {
	  ...
	  $actions = array(
	            ...
	            'price'      => sprintf('<a href="?page=%s&action=%s&ci=%s">Voir les prix</a>','price_per_cities_districts','view',$item['id']),
	...
	public function no_items() {
	  _e( 'Pas de Villes ou quartiers disponible.', 'e-boutique');
	}
